...
namespace Models
{
    public abstract class Spaceship : IEquatable<Spaceship>,  ISpaceship
    {
        ...
        public void AddWeapon(Weapon weapon)
        {
            ...
            // évite de dépasser le nombre maximum d'armes sur le vaisseau
        ...
        //     {
        //         try {
        //             ship.AddWeapon(Armory.CreateWeapon(Armory.Blueprints[rnd.Next(0, Armory.Blueprints.Count)]));
